...
/**
 * @author skycity
 * @create 2019-10-22 19:17
 */

public class RedisCustomCacheWriter implements RedisCacheWriter {
    //缓存写入实现
     ...
     */
    public RedisCustomCacheWriter(RedisConnectionFactory connectionFactory) {
     ...
     *          to disable locking.
     */
    RedisCustomCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
